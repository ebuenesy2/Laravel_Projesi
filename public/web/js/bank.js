$(function () {
    ...
    document.querySelectorAll('.modal_info').forEach(function (i) {
        i.addEventListener('click', function (event) {
            ...
            //! Yazma
            $('#bank_name_update').val(data_name);
            $('#bank_name_update').attr("data_token",data_token);
    ...
    $('#bank_update').click(function (e) {
        ...
        //! Text
        var bank_name_update = $('#bank_name_update').val();
        var bank_token_update = $('#bank_name_update').attr("data_token");
        ...
        if (bank_name_update) {
            ...
            $.ajax({
                ...
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
                    token: bank_token_update,
                    bankTitle: bank_name_update
                },
                success: function (response) {
                    // alert("başarılı");
                    //console.log("response:", response);
