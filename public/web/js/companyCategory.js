$(function () {
        ...
        i.addEventListener('click', function (event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    //! Ajax         
                    $.ajax({
                        url: "/company/category/update/active",
                        method: "post",
    ...
    $('#new_add').click(function (e) {
        ...
        //! Text
        var companyCategoryTitle = $('#companyCategoryTitle').val();
        
        if (companyCategoryTitle) {
            ...
            $.ajax({
                ...
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
                    categoryTitle: companyCategoryTitle
                },
                success: function (response) {
                    // alert("başarılı");
                    //console.log("response:", response);
    ...
    document.querySelectorAll('.modal_info').forEach(function (i) {
        i.addEventListener('click', function (event) {
            ...
            //! Yazma
            $('#companyCategoryTitle_update').val(data_categoryTitle);
            $('#companyCategoryTitle_update').attr("data_token",data_token);
            
             //! Return
            console.log("data_id:", data_id);
            console.log("data_token:", data_token);
            console.log("data_categoryTitle:", data_categoryTitle); 
    ...
    $('#db_update').click(function (e) {
        ...
        //! Text
        var companyCategoryTitle_update = $('#companyCategoryTitle_update').val();
        var companyCategoryTitle_Token_update = $('#companyCategoryTitle_update').attr("data_token");
        
        //console.log("bank_name_update:", bank_name_update);
        //console.log("bank_name_update:", bank_token_update);
        
        if (companyCategoryTitle_update) {
            
                     
            //! Ajax         
            $.ajax({
                url: "/company/category/update",
                method: "post",
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
                    token: companyCategoryTitle_Token_update,
                    cargoCompanyTitle: companyCategoryTitle_update
                },
                success: function (response) {
                    // alert("başarılı");
                    //console.log("response:", response);
