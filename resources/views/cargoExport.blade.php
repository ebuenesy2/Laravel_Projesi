...
<head>
    ...
    <title>Ajax Dersleri | Konu </title>
        ...
        <body class="c9 doc-content">
            ...
            <table class="c6">
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">F&#304;RMA M&Uuml;&#350;TER&#304; NO </span></p>
                    </td>
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">1234567890</span></p>
                    </td>
                </tr>
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Depo firmas&#305; ne ise o</span></p>
                    </td>
                </tr>
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Mardin deki tr depo</span></p>
                    </td>
                </tr>
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Depo sorumlusu tel</span></p>
                    </td>
                </tr>
            </table>
            ...
            <table class="c6">
                <tr class="c3">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Campony.json firma ad&#305;</span></p>
                    </td>
                </tr>
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Campony.json firma adresi</span></p>
                    </td>
                </tr>
                <tr class="c3">
                    <td class="c0" colspan="1" rowspan="1">
                    ...
                    <td class="c5" colspan="1" rowspan="1">
                        <p class="c4"><span class="c1">Campony.json firma telefon gsm ama</span></p>
                    </td>
                </tr>
            </table>
            <p class="c7 c8"><span class="c1"></span></p>
            <p class="c2"><span
                    style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 152.45px; height: 160.99px;"><img
                        alt="" src="https://data.yildirimdev.com/images/4-qr_barkod/0_qr_bex360.png"
