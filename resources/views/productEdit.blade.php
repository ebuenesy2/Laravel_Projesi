...
<html lang="en-us">
    <head>
        ...
        <title>Ürün Düzenleme | Yıldırımdev</title>
                    ...
                    <div class="c-toolbar u-justify-between u-mb-medium">
                        <nav class="c-counter-nav">
                            <div class="c-counter-nav__item">
                                <a style="text-decoration:none" class="c-counter-nav__link is-active" href="/product/edit/{{$apiDB['id']}}">
                        ...
                        <a style="text-decoration:none"  id="product_update_step1"  ><span class="c-badge c-badge--small c-badge--success">Güncelle</span></a>
                    </div>
                        ...
                        <div class="c-tabs__pane active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="c-field u-mb-small" style="display: none;" >
                                        <label class="c-field__label" for="categoryToken">Kategori Token</label>
                                        <input class="c-input" type="text" id="categoryToken" placeholder="Kategori Token" value="{{$categoryToken}}">
                                    </div>
                                   ...
                                   <div class="c-field u-mb-small">
                                        ...
                                        <select id="brandTitle" class="form-select" style="height: 40px;border: 1px solid #dfe3e9;border-radius: 8px;font-size: .875rem;font-weight: 500;outline: 0;width: 100%;padding-left: .9375rem; margin-bottom: 10px;">
                                            <option value="0"  selected="false" >Marka Seçiniz</option>
                                             @for ($i = 0; $i < count($brandDB); $i++)
                                                <option value="{{$brandDB[$i]['id']}}" data-token="{{$brandDB[$i]['token']}}"  {{ $brandDB[$i]['token'] == $apiDB['brandToken'] ? "selected" : ""   }} >{{$brandDB[$i]['brandTitle']}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                     ...
                                     <div class="c-field u-mb-small">
                                        ...
                                        <input class="c-input" type="text" id="productName" placeholder="Ürün Adı" value="{{$apiDB['productName']}}" >
                                    </div>

                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="productCode">Ürün Kodu</label>
                                        <input class="c-input" type="text" id="productCode" placeholder="Ürün Kodu" value="{{$apiDB['productCode']}}" >
                                    </div>
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <div class="c-field u-mb-small">
                                        ...
                                        <input class="c-input" type="number" id="productStock" placeholder="Stok Sayısı" value="{{$apiDB['productStock']}}" >
                                    </div>
                                   ...
                                   <div class="c-field u-mb-small">
                                    ...
                                    <div class="c-field u-mb-small">
                                        ...
                                        <input class="c-input" type="text" id="productPrice" placeholder="Satış Fiyatı" value="{{$apiDB['productPrice']}}" >
                                    </div>
                                </div>
                                
                                 <div class="col-lg-12">
                                    <label class="c-field__label" for="description">Açıklama</label>
                                    <textarea id="description" class="c-input" rows="10" maxlength="250">{!!$apiDB['description']!!}</textarea>
