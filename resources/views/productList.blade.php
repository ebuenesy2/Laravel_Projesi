                    ...
                    <div class="modal-content">
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                ...
                                <button class="c-btn c-btn--info c-btn--fullwidth" id="user_add">
                                    Yeni Ekle
                                </button>
                            </form>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="c-card u-p-medium">
                            <ul class="nav nav-tabs nav-justified style-2 rounded-top" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a style="text-decoration:none" class="nav-link active" id="productInfo-tab" data-toggle="tab" href="#productInfo"
                                        role="tab" aria-controls="productInfo" aria-selected="false">Ürün Bilgileri</a>
                                </li>
                                <li class="nav-item">
                                    <a style="text-decoration:none" class="nav-link" id="price-tab" data-toggle="tab" href="#price" role="tab"
                                        aria-controls="price" aria-selected="false">Fiyat</a>
                                </li>
                                <li class="nav-item">
                                    <a style="text-decoration:none" class="nav-link" id="customerInfo-tab" data-toggle="tab" href="#customerInfo"
                            ...
                            <div class="tab-content p-4 bg-white rounded-bottom" id="myTabContent">
                                ...
                                <div class="tab-pane fade show" id="customerInfo" role="tabpanel"
                                    aria-labelledby="customerInfo-tab">
                ...
                <div class="col-md-12">
                        ...
                        <table id="myTable" class="c-table">
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    ...
                                    <th class="c-table__cell c-table__cell--head" style="display: none;">Kategori </th>
                                    <th class="c-table__cell c-table__cell--head" style="display: none;" >Kayıt Yeri </th>
                                    <th class="c-table__cell c-table__cell--head"  style="display:{{$userRoleToken == 'token' ? 'flex' : 'none'}}">Firma Adı</th>
                            ...
                            <tbody >
                                ...
                                <tr class="c-table__row">
                                        ...
                                        <!---- Bilgileri --->
                                        <td class="c-table__cell" style="width: 50%;"  > {{$data["productName"]}} </td>
                                        <td class="c-table__cell"> {{$data["productCode"]}}</td>
                                        <td class="c-table__cell"  style="display: none;" > {{$data["categoryTitle"]}}</td>
                                        <td class="c-table__cell"  style="display: none;" > {{$data["siteName"]}}</td>
                                        <td class="c-table__cell"  style="display:{{$userRoleToken == 'token' ? '' : 'none'}}" > {{$data["companyTitle"]}}</td>
                                        ...
                                        <td class="c-table__cell"> 
                                            ...
                                            <li class="u-text-large" ><a style="text-decoration:none" class="u-text-mute" ><i class="fa fa-trash" style="color: #ed1c24;; font-size: 30px;" id="listItemDelete" data_id="{{$data['id']}}" ></i></a></li>
                                            <li class="u-text-large" > <a style="text-decoration:none" class="u-text-mute" href="/product/view/{{$data['id']}}" ><i class="fa fa-info-circle" style="color: blue; font-size: 30px;"></i></a></li>
                                            <li class="u-text-large" > <a style="text-decoration:none" class="u-text-mute" href="/product/edit/{{$data['id']}}"  ><i class="fa fa-pencil-square" style="color: gray; font-size: 30px;"></i></a></li>
                                            </ul>
                                        </td>
                                        <!---- Action Son --->
                    ...
                    <tbody style="display: flex;gap: 30px;" >
                            ...
                            <tr style="display: flex;gap: 10px;" >
                                ...
                                <th>   
                                    <select id="row_count" class="form-select" style="height: 40px;border: 1px solid #dfe3e9; font-size: .875rem;font-weight: 500;outline: 0;width: 100%;padding-left: .9375rem; margin: auto;">
