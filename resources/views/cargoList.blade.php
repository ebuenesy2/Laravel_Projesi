...
<html lang="en-us">
    <head>
        ...
        <title>Kargo Listesi | Yıldırımdev</title>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="c-card__body" method="post" action="javascript:void(0)">
                            ...
                            <div class="c-field u-mb-small" data-select2-id="4">
                                <label class="c-field__label" for="cargoCompanyListChange">Firma Kategorisi</label>
                ...
                <div class="c-modal__dialog modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="productUpload" data_token="{{$data['token']}}" data_companyToken="{{$data['companyToken']}}" class="btn btn-primary">Güncelle</button>
                    ...
                    <div class="c-table-responsive">
                        <div
                            ...
                            <div style="display:flex; gap:10px;" >
                                <p style="font-size: 19px; font-weight: bold; margin-top: auto; margin-bottom: auto; ">Kargo Listesi |  </p>
                        ...
                        <table id="myTable" class="c-table">
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    ...
                                    <th class="c-table__cell c-table__cell--head"  style="display:{{$userRoleToken == 'token' ? 'block' : 'none'}}" >Firma Adı</th>
                                    <th class="c-table__cell c-table__cell--head" style="width: 50%;">Kargo Firması</th>
                                    <th class="c-table__cell c-table__cell--head">Kargo Takip No</th>
                                    <th class="c-table__cell c-table__cell--head">Kargo Verilme Tarihi</th>
                            ...
                            <tbody >
                                @foreach ($apiDB as $data)
                                   <tr class="c-table__row">
                                        ...
                                        <td class="c-table__cell"> {{$data['cargo']['cargoCompanyTitle']}}</td>
                                        <td class="c-table__cell"> {{$data['cargo']['cargoTrackingCode']}}</td>
                                        <td class="c-table__cell"> {{$data["cargo"]["cargoDate"] ?  \Carbon\Carbon::parse($data["cargo"]["cargoDate"])->isoFormat('Do MMMM YYYY, HH:mm:ss') : ''}}</td>
