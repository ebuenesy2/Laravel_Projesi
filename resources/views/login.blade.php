...
<html lang="en-us">
    <head>
        ...
        <meta http-equiv="x-ua-compatible" content="ie=edge">
          <title>Üye Giriş | Yıldırımdev</title>
    ...
    <body class="o-page o-page--center" style="background-color: #eff3f6; ">
        ...
        <div class="o-page__card">
            <div class="c-card u-mb-xsmall">
                <header class="c-card__header u-pt-large">
                    ...
                    <h1 class="u-h3 u-text-center u-mb-zero" style="margin-bottom:15px"> Siteye Giriş Paneli </h1>
                ...
                <form action="{{route('login.control')}}" method="post" class="c-card__body" >
                    ...
                    <button class="c-btn c-btn--success c-btn--fullwidth" type="submit">Giriş</button>
            ...
            <div class="o-line">
                ...
                <a style="text-decoration:none" class="u-text-mute u-text-small" href="/forgot_password">Şifremi Unuttum</a>
            </div>
        </div>
    </body>
     ...
     <footer>
        ...
        <!--- bigdata --> 
       <script src="{{asset('/web')}}/js/bigdata.js"></script>
