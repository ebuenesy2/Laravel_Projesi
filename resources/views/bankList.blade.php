...
<html lang="en-us">
    <head>
        ...
        <title>Banka Ayarları | Yıldırımdev</title>
                        ...
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="bank_name">Banka Adı</label>
                                    <input class="c-input" type="text" id="bank_name" placeholder="Banka Adı" />
                                </div>

                                <button class="c-btn c-btn--info c-btn--fullwidth" id="bank_add"> Yeni Ekle </button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="c-modal__dialog modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="bank_name_update">Banka Adı</label>
                                    <input class="c-input" type="text" id="bank_name_update" data_token="data_token" placeholder="Banka Adı" />
                                </div>

                                <button class="c-btn c-btn--info c-btn--fullwidth" id="bank_update"> Güncelle </button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="c-table-responsive">
                        <div
                            ...
                            <div style="display:flex; gap:10px;" >
                                <p style="font-size: 19px; font-weight: bold; margin-top: auto; margin-bottom: auto; ">Banka Listesi |  </p>
                        ...
                        <table id="myTable" class="c-table">
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    ...
                                    <th class="c-table__cell c-table__cell--head" style="width: 80%;"  >Banka Adı</th>
                            ...
                            <tbody >
                                @foreach ($apiDB as $data)
                                   <tr class="c-table__row">
                                        ...
                                        <!---- Bilgileri --->
                                        <td class="c-table__cell"> {{$data["bankTitle"]}} </td>
                                        ...
                                        <td class="c-table__cell"> 
                                            <ul class="u-flex u-justify-between" style="gap: 10px; margin:auto;"> 
                                              ...
                                              <li class="u-text-large" > <a class="u-text-mute modal_info" data-toggle="modal" data-target="#myModal4" ><i data_id="{{$data['id']}}" data_token="{{$data['token']}}" data_name="{{$data['bankTitle']}}" class="fa fa-pencil-square" style="color: gray; font-size: 30px;"></i></a></li>
                                            </ul>
                                        </td>
                                        <!---- Action Son --->
    ...
    <footer>
        ...
        <!--- Js --> 
       <script src="{{asset('/web')}}/js/bank.js"></script>
