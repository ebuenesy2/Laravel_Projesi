...
<html lang="en-us">
    <head>
        ...
        <title>Firma Kategori Ayarları | Yıldırımdev</title>
                        ...
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="companyCategoryTitle">Firma Kategorisi</label>
                                    <input class="c-input" type="text" id="companyCategoryTitle" placeholder="Kargo Firması" />
                                </div>
                   ...
                   <div class="c-modal__dialog modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="companyCategoryTitle_update">Firma Kategorisi</label>
                                    <input class="c-input" type="text" id="companyCategoryTitle_update" data_token="data_token" placeholder="Kargo Firması" />
                                </div>
                    ...
                    <div class="c-table-responsive">
                        <div
                            ...
                            <div style="display:flex; gap:10px;" >
                                <p style="font-size: 19px; font-weight: bold; margin-top: auto; margin-bottom: auto; ">Firma Kategorisi  Listesi |  </p>
                                <p style="margin:auto;">{{$apiDBCount}}</p>
                            </div>
                            
                            <button type="button" class="c-btn c-btn--success" data-toggle="modal" data-target="#myModal3"> Firması Kategorisi Ekle </button>
                        ...
                        <table id="myTable" class="c-table">
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    ...
                                    <th class="c-table__cell c-table__cell--head" style="width: 80%;" >Firma Kategori Adı</th>
                                   ...
                                   <tr class="c-table__row">
                                        ...
                                        <td class="c-table__cell"> 
                                            <ul class="u-flex u-justify-between" style="gap: 10px; margin:auto;"> 
                                              ...
                                              <li class="u-text-large" > <a class="u-text-mute modal_info" data-toggle="modal" data-target="#modaldetail" ><i class="fa fa-pencil-square" data_id="{{$data['id']}}" data_token="{{$data['token']}}" data_categoryTitle="{{$data['categoryTitle']}}"  style="color: coral; font-size: 30px;"></i></a></li>
    ...
    <footer>
        ...
        <!--- Js --> 
       <script src="{{asset('/web')}}/js/companyCategory.js"></script>
