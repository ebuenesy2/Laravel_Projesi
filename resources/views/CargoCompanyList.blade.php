...
<html lang="en-us">
    <head>
        ...
        <title>Kargo Firma Ayarları | Yıldırımdev</title>
                        ...
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="cargoCompanyTitle">Kargo Firması</label>
                                    <input class="c-input" type="text" id="cargoCompanyTitle" placeholder="Kargo Firması" />
                                </div>
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="cargoCustomerId">Kargo Müşteri Numarası</label>
                                    <input class="c-input" type="text" id="cargoCustomerId" placeholder="Müşteri No" />
                                </div>
                   ...
                   <div class="c-modal__dialog modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="c-card u-p-medium">
                            ...
                            <form class="c-card__body" method="post" action="javascript:void(0)">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="cargoCompanyTitle_update">Kargo Firması</label>
                                    <input class="c-input" type="text" id="cargoCompanyTitle_update" data_token="data_token" placeholder="Kargo Firması" />
                                </div>
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="cargoCustomerId_update">Kargo Müşteri Numarası</label>
                                    <input class="c-input" type="text" id="cargoCustomerId_update" placeholder="Müşteri No" />
                                </div>

                                <button class="c-btn c-btn--info c-btn--fullwidth" id="db_update"> Veri Güncellendi </button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="c-table-responsive">
                        <div
                            ...
                            <div style="display:flex; gap:10px;" >
                                <p style="font-size: 19px; font-weight: bold; margin-top: auto; margin-bottom: auto; ">Kargo Firma Listesi |  </p>
                                <p style="margin:auto;">{{$apiDBCount}}</p>
                            </div>
                            
                            <button type="button" class="c-btn c-btn--success" data-toggle="modal" data-target="#myModal3"> Kargo Firması Ekle </button>
                        ...
                        <table id="myTable" class="c-table">
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    ...
                                    <th class="c-table__cell c-table__cell--head" style="width: 80%;" >Kargo Firma Adı</th>
                                    <th class="c-table__cell c-table__cell--head" style="display:none;">Müşteri ID</th>
                            ...
                            <tbody >
                                @foreach ($apiDB as $data)
                                   <tr class="c-table__row">
                                        ...
                                        <!---- Bilgileri --->
                                        <td class="c-table__cell"> {{$data["cargoCompanyTitle"]}} </td>
                                        <td class="c-table__cell" style="display:none;"> {{$data["cargo_customerId"]}}</td>
                                        ...
                                        <td class="c-table__cell"> 
                                            <ul class="u-flex u-justify-between" style="gap: 10px; margin:auto;"> 
                                              ...
                                              <li class="u-text-large" > <a class="u-text-mute modal_info" data-toggle="modal" data-target="#modaldetail" ><i class="fa fa-pencil-square" data_id="{{$data['id']}}" data_token="{{$data['token']}}" data_cargoCompanyTitle="{{$data['cargoCompanyTitle']}}"  data_cargo_customerId="{{$data['cargo_customerId']}}" style="color: coral; font-size: 30px;"></i></a></li>
    ...
    <footer>
        ...
        <!--- Js --> 
       <script src="{{asset('/web')}}/js/cargoCompany.js"></script>
