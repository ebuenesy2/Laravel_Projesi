...
<html lang="en-us">
    <head>
        ...
        <title>Ürün Düzenleme -2 | Yıldırımdev</title>
    ...
    <body class="o-page" style="background-color: #eff3f6; ">
        ...
        @include('include.sidebar')
         ...
         <div class="container">
            <div class="container">
                <div class="col-12">
                   <p id="product_info" data_id="{{$apiDB['id']}}" data_token="{{$apiDB['token']}}"  style="display:none;" >Ürün bilgileri</p>
                    ...
                    <div class="c-toolbar u-justify-between u-mb-medium">
                        <nav class="c-counter-nav">
                            ...
                            <div class="c-counter-nav__item">
                                <a style="text-decoration:none" class="c-counter-nav__link is-active" href="/product/edit/{{$apiDB['id']}}/step2">
                                    <span class="c-counter-nav__counter">2</span>Ürün Resimleri
                                </a>
                            </div>
                            <div class="c-counter-nav__item">
                                <a style="text-decoration:none" class="c-counter-nav__link" href="/product/edit/{{$apiDB['id']}}/step3">
                        ...
                        <div style="display:flex; gap:10px; ">
                              <a style="text-decoration:none" id="product_update_step2"  ><span class="c-badge c-badge--small c-badge--success">Güncelle</span></a>
                        </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="c-field u-mb-small">
                                        <img id="productImageUrl" style="width: 100%;height: 100%;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px;" src="{{$apiDB['productImageUrl']}}" alt="" >
                                    </div>
                                    ...
                                    <div class="c-field u-mb-small">
                                        ...
                                        <div
                                            ...
                                            <form action="{{ route('file.upload.control') }}" method="POST"
                                                id="uploadForm_productImage" enctype="multipart/form-data">
                                                <div style="display: flex; flex-direction: column; gap: 15px;">
                                                    <input type="file" name="file" id="fileInput"
                                                        style="display: flex; color: steelblue; margin-left: 10px; ">
                                                    <button type="submit" name="submit" class="btn btn-success"
                                                        style="background-image: linear-gradient(#04519b, #033c73 60%, #02325f);color: #ffffff;border-bottom: 1px solid #022241;padding: 12px;width: 300px;border-radius: 6px;display: flex;justify-content: center;">
                                                        <div
                                                            ...
                                                            <p
                                                                style="color: blanchedalmond;font-size: 14px;font-weight: bold;margin: auto;">
                                                                Dosya Yükle </p>
                                                        </div>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" id="progressBarUser" role="progressbar"
                                                    aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;background-color: teal;color: rgb(255, 255, 255);border-radius: 6px;display: flex;justify-content: center;">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                   ...
                                   <div class="c-field u-mb-small">
                                    ...
                                    <div class="c-feed__gallery" style="display: flex;flex-direction: row; ">
                                        ...
                                        <div class="c-feed__gallery-item" id="productImageViewList" data_id="2" style="display:{{$apiDB['productOtherImageUrl2'] != null ? 'flex' : 'none'  }};  position: relative;" >
                                            ...
                                            <img id="productImageView" data_id="2" style="width: 100px;height: 100px;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px; float: left;"
                                               src="{{$apiDB['productOtherImageUrl2']}}" />
                                        </div>
                                        <div class="c-feed__gallery-item" id="productImageViewList" data_id="3" style="display:{{$apiDB['productOtherImageUrl3'] != null ? 'flex' : 'none'  }}; position: relative;" >
                                            ...
                                            <img id="productImageView" data_id="3" style="width: 100px;height: 100px;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px; float: left;"
                                                src="{{$apiDB['productOtherImageUrl3']}}" />
                                        </div>
                                            
                                        
                                        <div class="c-feed__gallery-item" id="productImageViewList" data_id="4" style="display:{{$apiDB['productOtherImageUrl4'] != null ? 'flex' : 'none'  }}; position: relative;" >
                                            ...
                                            <img id="productImageView" data_id="4" style="width: 100px;height: 100px;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px; float: left;"
                                                src="{{$apiDB['productOtherImageUrl4']}}" />
                                        </div>
                                        <div class="c-feed__gallery-item" id="productImageViewList" data_id="5" style="display:{{$apiDB['productOtherImageUrl5'] != null ? 'flex' : 'none'  }}; position: relative;" >
                                            ...
                                            <img id="productImageView" data_id="5" style="width: 100px;height: 100px;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px; float: left;"
                                                src="{{$apiDB['productOtherImageUrl5']}}" />
                                        </div>
                                        <div class="c-feed__gallery-item" id="productImageViewList" data_id="6" style="display:{{$apiDB['productOtherImageUrl6'] != null ? 'flex' : 'none'  }}; position: relative;" >
                                            ...
                                            <img id="productImageView" data_id="6" style="width: 100px;height: 100px;object-fit: cover;border: 1px solid #d1cece;border-radius: 5px; float: left;"
